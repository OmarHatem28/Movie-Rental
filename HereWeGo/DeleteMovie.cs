    ...
    public partial class DeleteMovie : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                command.CommandText = "Delete from IS_A where MovieCode = "+textBox1.Text+
                                        " Delete from HAS_A where CODE = "+ textBox1.Text+
                                        " Delete from MOVIE where CODE = " + textBox1.Text;
